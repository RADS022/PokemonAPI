...
export declare class PokemonsService {
    ...
    constructor(pokemonModel: Model<PokemonDocument>);
    create(createPokemonDto: CreatePokemonDto): Promise<Pokemon>;
    findAll(): Promise<(import("mongoose").Document<unknown, any, Pokemon> & Pokemon & {
        _id: import("mongoose").Types.ObjectId;
    } & Required<{
        _id: import("mongoose").Types.ObjectId;
    }>)[]>;
    findOne(id: string): Promise<import("mongoose").Document<unknown, any, Pokemon> & Pokemon & {
        _id: import("mongoose").Types.ObjectId;
    } & Required<{
        _id: import("mongoose").Types.ObjectId;
    }>>;
